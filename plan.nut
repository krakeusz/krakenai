...
function RoadConnectionPlan::_ChooseBestEngineId()
{
}
...
RoadConnectionPlan::constructor(producerId, consumerId, cargoId)
{
  ...
  _AddAction(FindBestTruckEngineAction());
  _AddAction(ProvideStationAction(producerId, cargoId, producerTileString, EndpointType.Producer));
  _AddAction(ProvideStationAction(consumerId, cargoId, consumerTileString, EndpointType.Consumer));
